matfiles = dir('../../input/stab_ctrl/mditerm/*.mat');
...
for i = 1:length(matfiles)
    filename = matfiles(i).name;
    load(filename)
    inputfilename = sprintf("../../input/stab_ctrl/mditerm/%s_Tfac_vs_cg_range.csv", filename(1:2));
    ...
    outputfilename = sprintf("../../output/stab_ctrl/midterm/%s_cg_range_Ppe.csv", filename(1:2));
...
for i = 1:length(matfiles)
    ...
    savename = sprintf("../../output/stab_ctrl/midterm/%s_cg_range_frontwing_location.csv", filename(1:2));
...
for i = 1:length(matfiles)
    ...
    savename = sprintf("../../output/stab_ctrl/midterm/%s_cg_range_rearwing_location.csv", filename(1:2));
    writematrix(res, savename)
    % figure;
    % hold on
    % plot(res(1,:), res(3,:))
...
for i = 1:length(matfiles)
    filename = matfiles(i).name;
    load(filename)
    Ppename = sprintf("../../output/stab_ctrl/midterm/%s_cg_range_Ppe.csv", filename(1:2));
    Fwname = sprintf("../../output/stab_ctrl/midterm/%s_cg_range_frontwing_location.csv", filename(1:2));
    Rwname = sprintf("../../output/stab_ctrl/midterm/%s_cg_range_rearwing_location.csv", filename(1:2));
