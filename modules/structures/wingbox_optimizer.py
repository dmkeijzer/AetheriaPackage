...
if __name__ == "__main__":
    ...
    GetWingWeight( ,engine,material,aero)
...
#         axs[0, 0].plot(y,wingbox_hf.lift_func(y)*wingbox_hf.n_ult/1e3,label="Horizontal flight",linewidth=1.5)
#         axs[0, 0].plot(y,wingbox_vf.thrust_z_from_tip(x_final)/1e3, label = "Vertical flight",linestyle='dashed',linewidth=1.5)
...
#         axs[1, 0].plot(y, wingbox_hf.weight_from_tip(x_final)*9.81/1e3,linewidth=1.5, label = "Horizontal flight")
#         plt.gca().grid()
...
#         axs[2, 0].plot(y, wingbox_hf.shear_z_from_tip(x_final)/1e3,linewidth=1.5, label = "Horizontal flight")
...
#         axs[0, 1].plot(y, wingbox_hf.moment_x_from_tip(x_final)/1e3,linewidth=1.5, label = "Horizontal flight")
#         plt.gca().grid()
...
#         axs[1, 1].plot(y, wingbox_hf.bending_stress_x_from_tip(x_final)/1e6,linewidth=1.5, label = "Horizontal flight")
#         plt.gca().grid()
...
#         axs[2, 1].plot(y, wingbox_hf.shearflow_max_from_tip(x_final)/1e3,linewidth=1.5, label = "Horizontal flight")
...
#         # axs[1, 0].set_title('Weight')
#         axs[1, 0].plot(y, wingbox_vf.weight_from_tip(x_final)*9.81/1e3,linestyle='dashed',linewidth=1.5, label = "Vertical flight")
#         axs[1, 0].grid()
#         # axs[1, 0].set_xlabel("Span location y [m]")
#         axs[1, 0].set_ylabel("Weight [kN]")
#         print("Weight at root = ",wingbox_vf.weight_from_tip(x_final)[0]*9.81/1e3,"[kN]")
#         # axs[2, 0].set_title('Shear force')
#         axs[2, 0].plot(y, wingbox_vf.shear_z_from_tip(x_final)/1e3,linestyle='dashed',linewidth=1.5, label = "Vertical flight")
#         axs[2, 0].grid()
...
#         # axs[0, 1].set_title('Moment')
#         axs[0, 1].plot(y, wingbox_vf.moment_x_from_tip(x_final)/1e3,linestyle='dashed',linewidth=1.5, label = "Vertical flight")
#         axs[0, 1].grid()
...
#         # axs[1, 1].set_title('Axial stress')
#         axs[1, 1].plot(y, wingbox_vf.bending_stress_x_from_tip(x_final)/1e6,linestyle='dashed',linewidth=1.5, label = "Vertical flight")
#         axs[1, 1].grid()
#         # axs[1, 1].set_xlabel("Span location y [m]")
#         axs[1, 1].set_ylabel("Axial stress [MPa]")
#         print("Axial stress at root = ",wingbox_vf.bending_stress_x_from_tip(x_final)[0]/1e6,"[MPa]")
#         # axs[2, 1].set_title('Max shear flow')
#         axs[2, 1].plot(y, wingbox_vf.shearflow_max_from_tip(x_final)/1e3,linestyle='dashed',linewidth=1.5, label = "Vertical flight")
#         axs[2, 1].grid()
...
#         axs[0, 1].legend(fontsize=_fontsize)
#         axs[1, 0].legend(fontsize=_fontsize)
#         axs[1, 1].legend(fontsize=_fontsize)
#         axs[2, 0].legend(fontsize=_fontsize)
#         axs[2, 1].legend(fontsize=_fontsize)
