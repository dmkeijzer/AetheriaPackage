...
if __name__ == '__main__':
    ...
    constraints = [
        {'type': 'ineq', 'fun': wingbox.buckling_constr},
        {'type': 'ineq', 'fun': wingbox.local_column},
        {'type': 'ineq', 'fun': wingbox.global_local},
        {'type': 'ineq', 'fun': wingbox.von_Mises},
        {'type': 'ineq', 'fun': wingbox.flange_loc_loc},
        {'type': 'ineq', 'fun': wingbox.crippling},
        {'type': 'ineq', 'fun': wingbox.web_flange},
    ]
    ...
    out = minimize(wingbox.total_weight, x, method='SLSQP',
