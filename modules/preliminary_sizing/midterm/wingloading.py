...
def plot_wing_power_loading_graphs(dict_directory,dict_name,i):
    ...
    CLIMBRATE = cont_factor*powerloading_climbrate(data['eff'], data['roc'], WS_range,const.rho_cr,data['cd0'],data['e'],data['A'])
    ...
    TW_max = powerloading_thrustloading(WS_max,const.rho_sl,data['roc'],data['StotS'])
