...
weight_J1.add_component(Fuselage(J1["name"], J1["mtom"], np.pi*J1["w_fuse"], J1["l_fuse"], npax + 1 ))
...
weight_L1.add_component(Fuselage(L1["name"], L1["mtom"], np.pi*L1["w_fuse"], L1["l_fuse"], npax + 1 ))
...
weight_W1.add_component(Fuselage(W1["name"], W1["mtom"], np.pi*W1["w_fuse"], W1["l_fuse"], npax + 1 ))
