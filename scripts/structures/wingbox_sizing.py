...
wb.penalty_multiplier = 1


#------------------------------- Run script and save----------------------------------------------

x0=np.array([ 0.003, 0.002, 0.01, 0.01, 0.010,0.003,0.004,0.0022])    # :param x0: Initial estimate Design vector X = [b, cr, tsp, trib, L, bst, hst, tst, wst, t]
...
# This works
lb = [ 0.001, 0.001, 0.003, 0.001, 0.001, 0.001, 0.002, 0.001]
ub = [ 0.009, 0.003, 0.015, 0.02, 0.10, 0.004, 0.005, 0.003]
bnds = Bounds(lb, ub, keep_feasible= True)
# Res = minimize(RosenbrockN, x0, method = 'trust-constr', constraints=lcons) 
res = wb.wingbox_optimization(x0, bnds, WingClass, wb.penalty_multiplier)
...
print(f"\nExited succesfully = {res.success} ")
