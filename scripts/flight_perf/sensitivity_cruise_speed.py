...
for dict_name in dict_names:
    ...
    t_lst = []
    cruise_alt = 2400
    for i in range(60, max_cruise_v, 20):
        cruise_speed = i
        cruise_lst.append(cruise_speed)
        ...
        #-----------------------------Cruise-----------------------
        # print('-------- cruise')
        P_cr = powercruise(data["mtom"], const.g0, cruise_speed, AeroClass.ld_cruise, prop_eff_var)
        print("P_Cr", P_cr)
        ...
        t_cr = (const.mission_dist - d_desc - d_climb - final_trans_distance - final_trans_distance_landing)/cruise_speed
        E_cr = P_cr * t_cr
        # print('t', t_cr)
