import numpy as np
def place_gear(tire_radius,Dp,x_corner,x_cg_aft,x_cg_fwd,z_cg,fuselage_width,h_engine_inner,h_engine_outer,y_engine_inner,y_engine_outer,y_additional=0,tipback=15*np.pi/180,landing_gear_strut_max_limit=0.6,x_min_for_front_lg=0.2):
...
h_lg_strut, x_lg_fwd, x_lg_main= place_gear(tire_radius=0.3,Dp=2,x_corner=6,x_cg_aft=4.7,x_cg_fwd=4.5,z_cg=1,fuselage_width=2,h_engine_inner=2,h_engine_outer=2,y_engine_inner=4,y_engine_outer=5,y_additional=0,tipback=15*np.pi/180,landing_gear_strut_max_limit=0.6)
