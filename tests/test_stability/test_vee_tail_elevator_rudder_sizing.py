...
from scripts.vee_tail_elevator_rudder_sizing import get_K, get_c_control_surface_to_c_vee_ratio, get_tail_dihedral_and_area, get_control_surface_to_tail_chord_ratio
...
def example_values():
    return {
        ...
        "get_control_surface_to_tail_chord_ratio": {"downwash_angle_landing": 0.14, "aoa_landing": 0.2, "CL_h": -0.5, "CL_a_h":5, "V_tail_to_V_ratio": 0.9, "l_v": 5, "S": 10,"c": 1,"taper_h": 0.4, "AR_h": 4}
    }
